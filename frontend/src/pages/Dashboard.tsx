  ...
  return (
    <div className="page-frame space-y-8">
      <div className="flex items-end justify-between gap-4 animate-fade-up">
        <div>
          <p className="page-kicker">scan archive</p>
          <h1 className="section-title mt-2 text-[var(--text)]">Dashboard</h1>
      ...
      <Card className="animate-fade-up stagger-4 overflow-hidden">
        <div className="border-b border-[var(--border-strong)] bg-[var(--surface-muted)] px-5 py-4">
          <h2 className="text-sm font-black text-[var(--text)]">History</h2>
        </div>
        ...
        {loading ? (
          ...
          <div className="py-20 text-center">
            ...
            <p className="text-sm font-bold text-[var(--text-secondary)]">No analyses yet</p>
