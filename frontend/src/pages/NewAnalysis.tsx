...
export function NewAnalysis() {
  ...
  const pctLabel = threshold <= 55 ? "Longgar" : threshold <= 70 ? "Normal" : threshold <= 85 ? "Ketat" : "Sangat Ketat";
  ...
  return (
    <div className="page-frame max-w-2xl space-y-6">
      <div className="animate-fade-up">
        <p className="page-kicker">pengaturan analisis</p>
        <h1 className="section-title mt-2 text-[var(--text)]">Scan Baru</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 animate-fade-up stagger-1">
        <Card className="p-5">
          <label className="mb-2 block text-sm font-black text-[var(--text)]">URL Channel</label>
          <input
            type="url"
            value={url}
        ...
        <Card className="p-5 space-y-5 animate-fade-up stagger-2">
          <div>
            <div className="mb-4 flex items-baseline justify-between gap-4">
              <label className="text-sm font-black text-[var(--text)]">Ambang Kemiripan</label>
            ...
            <div className="mt-2 flex justify-between gap-4">
              <span className="text-[11px] text-[var(--text-secondary)]">0.40 — lebih banyak kandidat</span>
              <span className="text-[11px] text-[var(--text-secondary)]">0.95 — hampir identik</span>
            </div>
          </div>
